...
def get_data_transform(split, rgb_mean, rbg_std, key='default', dataset="ImageNet_LT"):
...
def load_data(data_root, dataset, phase, batch_size, sampler_dic=None, num_workers=4, test_open=False, shuffle=True):
    ...
    if phase not in ['train', 'val']:
        transform = get_data_transform('test', rgb_mean, rgb_std, key, dataset=dataset)
    else:
        transform = get_data_transform(phase, rgb_mean, rgb_std, key, dataset=dataset)
